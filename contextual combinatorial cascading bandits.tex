...
1. Our setting generalizes theirs, and our results with restricted to theirs is of same order except log

2. there is also other problem that can't be explained in their model even if without context information
