...
We evaluated $C^3$-UCB in three experiments and compared our algorithm to {\it CombCascade}, the most related one to ours. And we set the position discounts $\gamma_k$ to be $\gamma^{k-1}$ for some $\gamma$. 
