...
The main contributions of this paper can be summarized as follows: (1) we propose a general framework called contextual combinatorial cascading bandit that can many real-world application scenarios; 
