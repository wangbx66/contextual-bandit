...
\begin{figure*}
	...
	\subfigure[Disjunctive, $\gamma=1$]{
		\includegraphics[height = 3 cm, width = 5 cm]{synD-1.eps}}
	\subfigure[Disjunctive, $\gamma=0.95$]{
		\includegraphics[height = 3 cm, width = 5 cm]{synD-95.eps}}
	\subfigure[Network 3257 ]{
		\includegraphics[height = 3 cm, width = 5 cm]{network4-1.eps}}
	\subfigure[Conjunctive, network 1755, $\gamma=1$ ]{
		\includegraphics[height = 3 cm, width = 5 cm]{network3B-1.eps}}
