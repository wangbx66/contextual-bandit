...
\begin{figure}
	\centering
	\subfigure[$\gamma = 1$]{
		\includegraphics[height = 3cm, width = 3.95 cm]{movie-T10000-L100-K4-1.eps}}
	\subfigure[$\gamma = 0.95$]{
		\includegraphics[height = 3cm, width = 3.95 cm]{movie-T10000-L100-K4-95.eps}}
	\caption{MovieLens}
